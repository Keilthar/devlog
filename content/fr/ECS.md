...
<div style = "display: flex; justify-content: center; align-items: center;">
    <blockquote class="callout tip" data-callout="tip">
        <div style = "display: flex; justify-content: center; align-items: center;" class="callout-title">
            <div class="callout-icon"></div>
            <div class="callout-title-inner"><span>Tip :</span></div>
            <span>VAT (Vertex Animated Texture)</span>
        </div>
        <div>
            <span>C'est une technique d'animation qui stocke les mouvements des modèles dans une texture lue directement par le GPU.
            Allège fortement la charge CPU, au détriment d'un coût en RAM et d'une perte de flexibilité du process d'implémentation des animations.</span>
            <a href="https://stoyan3d.wordpress.com/2021/07/23/vertex-animation-texture-vat/" target="_blank">Lien vers un article anglais si vous voulez plus de détails.</a>
        </div>
    </blockquote>
</div>
...
C'est une architecture extrêmement puissante, qui a trouvé moult cas d'usage dans des simulations de :
- foules
- trafic
- villes / écosystèmes
