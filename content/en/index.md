    ...
    <blockquote class="callout tip" data-callout="tip">
        ...
        <div class="callout-content">
            <div class="callout-content-inner">
                <p>Just make it <strong>exist</strong> first, you can make it <strong>good</strong> later.</p>
            </div>
        </div>
    </blockquote>
</div>
...
So I'm doing my best to create a **Tower Defense** inspired by **[Orcs Must Die](https://store.steampowered.com/app/201790/Orcs_Must_Die_2/)** and **[Dungeon Defenders](https://store.steampowered.com/app/236110/Dungeon_Defenders_II/)**, with a touch of **horde mode** in the vein of **[They Are Billions](https://store.steampowered.com/app/644930/They_Are_Billions/)** and **[Age of Darkness: Final Stand](https://store.steampowered.com/app/1426450/Age_of_Darkness_Final_Stand/)** or **[Cataclismo](https://store.steampowered.com/app/1422440/Cataclismo/)**.

All of it with a **shareable map editor** and a **self-hosted multiplayer** mode, like we used to have back in the days of Age of Empires II and Warcraft 3 (yeah I'm a bit old, 80s kid...).

Quite a modest project, as you can tell ! And while I'm undeniably making slow progress, I'm also learning a ton along the way.

So I figured it's quite silly to keep all these experiences to myself when they might interest others too!
...
- **<span style="color: steelblue;">optimization</span>** and **<span style="color: steelblue;">performance</span>** (those aren't dirty words)
